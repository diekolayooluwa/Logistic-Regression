...
The goal is to understand changing consumer behavior in Nigeria’s evolving retail sector and provide data-driven insights for businesses, marketers, and policymakers.

# Objectives
Identify key factors influencing preference for online vs offline shopping.
Compare customer satisfaction between online and offline shopping experiences.
Examine the impact of demographic variables on shopping behavior.
Build a predictive logistic regression model for shopping preference.
# Methodology
Data Collection
Structured questionnaire survey
Sample size: 232 respondents
Respondents across different demographic backgrounds
